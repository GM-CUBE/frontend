                    ...
                    <div className="flex flex-wrap -m-4">
                         <div className="lg:w-1/3 lg:mb-0 mb-6 p-4">
                              <div className="h-full text-center">
                                   ...
                                   <h2 className="text-gray-900 font-medium title-font tracking-wider text-sm">CARLOS ANDRÉS CANCINO ESCOBAR</h2>
                         ...
                         <div className="lg:w-1/3 lg:mb-0 mb-6 p-4">
                              <div className="h-full text-center">
                                   ...
                                   <span className="inline-block h-1 w-10 rounded bg-indigo-500 mt-6 mb-4"></span>
                                   <h2 className="text-gray-900 font-medium title-font tracking-wider text-sm">JUAN PABLO GÓMEZ HARO CABRERA</h2>
                         ...
                         <div className="lg:w-1/3 lg:mb-0 p-4">
                              <div className="h-full text-center">
                                   ...
                                   <span className="inline-block h-1 w-10 rounded bg-indigo-500 mt-6 mb-4"></span>
                                   <h2 className="text-gray-900 font-medium title-font tracking-wider text-sm">IÑIGO QUINTANA DELFAILLO</h2>
